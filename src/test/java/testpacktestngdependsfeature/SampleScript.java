...
public class SampleScript {
    ...
    @Test(description = "verify the view button",groups={"sanity"})
    ...
    @Test(description = "verify the nfc button", groups = {"sanity"})
    ...
    @Test(description = "verify the Graphics button", groups = {"smoke"})
    ...
    @Test(description = "verify the Media button", groups = {"regression"})
